export default {
    pricing: {
        ...
        basic: {
            name: 'Basic',
            description: 'Perfect for trying out Shikuf and getting started with trading analytics.',
        ...
        premium: {
            name: 'Premium',
            description: 'Unlock the full potential of Shikuf with our Premium plan. Ideal for serious traders who want to take their trading to the next level.',
