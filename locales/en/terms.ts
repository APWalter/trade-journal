    ...
    terms: {
        ...
        sections: {
            companyInfo: {
                ...
                content: "Shikuf is owned and operated by Aryeh.",
                contact: "Contact: "
            },
            services: {
                title: "2. Services",
                content: "Shikuf provides access to a platform dashboard offering advanced analytics services for modern traders. We host trades data through Supabase, a SOC 2 compliant service."
            },
            userAccounts: {
            ...
            subscriptionPayments: {
                ...
                lifetimePlan: {
                    ...
                    description: "The \"Lifetime\" plan provides access to the Shikuf service for the operational lifetime of the service, subject to the following conditions:",
                    condition1: "The lifetime plan guarantees access for a minimum period of one (1) year from the date of purchase.",
                    condition2: "\"Lifetime\" refers to the operational lifetime of the Shikuf service, not the lifetime of the user.",
            ...
            intellectualProperty: {
                ...
                content: "Shikuf owns all intellectual property rights related to our service. Users are not permitted to copy or reproduce our service. Our code is licensed under the terms specified in our LICENSE file, which is the GNU Affero General Public License version 3."
            },
            dataProtection: {
            ...
            liability: {
                ...
                content: "To the fullest extent permitted by applicable law, Shikuf shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from (a) your use or inability to use the service; (b) any unauthorized access to or use of our servers and/or any personal information stored therein."
            },
            termination: {
                title: "8. Termination",
