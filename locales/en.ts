...
export default {
  ...
  "footer.copyright": "© {year} Shikuf. All rights reserved.",
  ...
  "authentication.testimonial":
    "Shikuf helped me understand my trading behaviors, and find new strategies I could earn from.",
  "authentication.testimonialAuthor": "Aryeh",
  ...
  "updates.title": "Shikuf Product Roadmap",
  "updates.description":
    "We're constantly working to improve Shikuf and provide you with the best trading analytics platform. Here's a look at our current progress, upcoming features, and recent updates.",
  ...
  "updates.milestone1.description":
    "We've laid the foundation for Shikuf with essential features. You can now process CSV data, view trades on a calendar, and access basic analytics. We've also implemented authentication and migrated to a robust Postgres database.",
  ...
  "updates.milestone6.description":
    "We've implemented a dark mode option, allowing users to comfortably use Shikuf in low-light environments and reduce eye strain during extended analysis sessions.",
  ...
  "updates.milestone8.description":
    "We're collaborating closely with Rithmic to implement automatic data import, streamlining the process of getting your trading data into Shikuf.",
  "updates.milestone9.title": "Import from Interactive Broker and AMP",
  "updates.milestone9.description":
    "We're expanding our import capabilities to include support for Interactive Broker and AMP, giving you more flexibility in how you bring your trading data into Shikuf.",
  ...
  "onboarding.welcome": "Welcome to Shikuf!",
  ...
  support: {
    greeting:
      "Welcome to the Shikuf Support Assistant! I'm here to help you gather all the necessary details about your issue or question. My goal is to collect the right context so your message can be efficiently forwarded to our customer support team, who will follow up with you by email.",
  ...
  maintenance: {
    ...
    email: {
      preview: "New Support Request from Shikuf",
